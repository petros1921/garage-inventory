...
import { LogIn, Wrench, AlertCircle, Eye, EyeOff } from 'lucide-react';
          ...
          <div className="mb-6">
            ...
            <div className="relative">
              <input
                ...
                className="w-full px-4 py-2 pr-11 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none"
                placeholder="••••••••"
                required
              />
              <button
